...
public class Objective4Lab2 {
  public static void main(String[] args) {
    ...
    int resultsInt = num1 + num2 + num3;

    double resultDouble = dub1 + dub2 + dub3;
    //TODO print the three ints and their sum.
    System.out.println(" The sum of " + num1 + " + " + num2 + " + " + num3 + " = " + resultsInt);
    System.out.println(" The sum of " + dub1 + " + " + dub2 + " + " + dub3 + " = " + resultDouble);
